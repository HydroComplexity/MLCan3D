### Model description
MLCan3D: The Windows version of the model is also fully exposed through the collaborative environment
...
2. Open main_MLCan.m file, select "Run File"
...
Wang, K. and Kumar, P. (In processing). Virtual Laboratory for Understanding Ecohydrologic Processes and Heterogeneity across Scales. 
...
### Contact Authors
* Kunxuan Wang: <mailto:kswang3@illinois.edu>
