...
% Last Modified by GUIDE v2.5 20-Sep-2021 21:29:47
...
Sub3DFlow       = get(handles.chk_3DFlow, 'Value');
...
% --- Executes on button press in chk_3DFlow.
function chk_3DFlow_Callback(hObject, eventdata, handles)
% hObject    handle to chk_3DFlow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of chk_3DFlow


% --- Executes on key press with focus on chk_HR and none of its controls.
function chk_HR_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to chk_HR (see GCBO)
...
% --- Otherwise, executes on mouse press in 5 pixel border or over chk_HR.
function chk_HR_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to chk_HR (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on key press with focus on chk_3DFlow and none of its controls.
function chk_3DFlow_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to chk_3DFlow (see GCBO)
% eventdata  structure with the following fields (see MATLAB.UI.CONTROL.UICONTROL)
%	Key: name of the key that was pressed, in lower case
%	Character: character interpretation of the key(s) that was pressed
