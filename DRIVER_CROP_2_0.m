...
load './Temps/temp_variable.mat'...
    ...
    'CO2_Elev_con' 'Soil_nutrient' 'litter_depth' 'Sub3DFlow'
...
SWITCHES.soil3D = Sub3DFlow;              %  1. use 3D rootsoil model, 0 use 1D rootsoil based on SWITCHES.ns=1;
...
addpath('./LOCAL_CODES/ROOT_SOIL/FLOW3D');
