...
%         litter_depth = 0.06; % [m] 
        ...
        ' Saturated hydraulic conductivity: Ksat'                               , 'Texture based'  , emp_cell  , 0.026    , '          m/hr';...
        ...
        save (fullpath_filename, ...
                        ...
                        'para_soilCN'           , 'para_numerical', 'para_soil3D', ...
...
%-------------------------------------------------------------------------%
% OPEN BUTTON ON START SCREEN TO OPE N FILES...                            %
%-------------------------------------------------------------------------%
...
% --- Executes on key press with focus on button_group_option and none of its controls.
function button_group_option_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to button_group_option (see GCBO)
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over button_group_option.
function button_group_option_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to button_group_option (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
